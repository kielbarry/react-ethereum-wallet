  ...
  return async function testFunction(dispatch) {
    const request = await web3.eth.call({
      ...
      data:
        ...
        '0x5F5F62E56620b94e406EA59F0bA3E9929e3B67a4'
          .substring(2)
          .replace(' ', ''),
    });

    return request.then(response => console.log, err => console.log);
  };
}
            ...
            let tokenArray = web3.eth
              ...
              .catch(function(error) {
                ...
                this.displayGlobalNotification({
                  ...
                  type: 'error',
                  msg:
                    'There was an error tokens for autoscan during a web3 call',
                  duration: 5,
                });
              });
          });
