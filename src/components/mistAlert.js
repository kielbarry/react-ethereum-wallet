  ...
  render() {
    ...
    return (
      <div className={newStyles}>
        <section>
          <h1> ⚠︎ Warning</h1>
          <button type="button" className="hide-alert close-button"
          onClick={ () => this.props.onClick() }>&times;</button>
          <p>
          ...
          <p>
            <a className="hide-alert button"
            onClick={ () => this.props.onClick() }>Close this message</a>
